...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<%=path%>singleservlet?method=getsubjectList" target="right"><span class="icon-caret-right"></span>在线考试</a></li>
 <li><a href="<%=path%>gradeservlet?method=history" target="right"><span class="icon-caret-right"></span>成绩管理</a></li>
  </ul>   
